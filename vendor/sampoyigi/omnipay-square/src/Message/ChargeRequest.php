...
class ChargeRequest extends AbstractRequest
{
    ...
    {
        return $this->getParameter('tip');
    }

    public function setTip($value)
    {
        return $this->setParameter('tip', $value);
    }
    ...
    public function getTipInteger()
    {   
        
        $tip = $this->getParameter('tip');
        $moneyParser = new DecimalMoneyParser($this->getCurrencies());

        $number = Number::fromString($tip);
    ...
    public function getData()
    {
        ...
        $tipMoney = new \SquareConnect\Model\Money();
        $tipMoney->setAmount($this->getTipInteger());
        $tipMoney->setCurrency($this->getCurrency());
